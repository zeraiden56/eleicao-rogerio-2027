...
const AtuacaoNoConselho = () => {
  ...
  const hasFilters = searchTerm || yearFilter !== "todos" || typeFilter !== "todos";
  ...
  return (
    <main className="min-h-screen pt-24">
      <SectionContainer background="default" padding="md" maxWidth="xl">
        <SectionTitle
          centered
          subtitle="Deliberações, resoluções e pareceres em que o Dr. Rogério atuou como conselheiro, relator ou proponente"
        >
          Atuação no Conselho Superior
        </SectionTitle>

        {/* Filtros */}
        <Card className="max-w-5xl mx-auto mt-10 p-5 md:p-7 border border-border/60 rounded-2xl">
        ...
        <div className="max-w-5xl mx-auto mt-8 space-y-4">
          ...
          {filteredDecisions.length === 0 && (
            <Card className="p-8 text-center text-muted-foreground border border-border/60 rounded-2xl">
              <Gavel className="w-10 h-10 text-muted-foreground/40 mx-auto mb-3" />
              <p className="text-sm">
                Nenhuma decisão encontrada com os critérios informados.
                <br />
          ...
          {filteredDecisions.map((decision) => (
            <Card
              key={decision.id}
              className="p-6 md:p-7 bg-card border border-border/60 rounded-2xl overflow-hidden relative scroll-reveal"
            >
              <span
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 pl-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-primary">
